...
mix.babel('node_modules/izitoast/dist/js/iziToast.min.js',
 ...
 mix.js('resources/assets/js/brands/brands.js', 'public/assets/js/brands/brands.js').version();


 mix.js('resources/assets/js/bookings/bookings.js', 'public/assets/js/bookings/bookings.js').version();
 ...
 mix.js('resources/assets/js/customers/customers.js', 'public/assets/js/customers/customers.js').version();


 mix.js('resources/assets/js/testimonies/testimonies.js', 'public/assets/js/testimonies/testimonies.js').version();
